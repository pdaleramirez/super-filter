...
class SearchTypeTest extends Unit
{
    ...
    protected function _before()
    {
        ...
        $this->searchTypes = SuperFilter::$app->searchTypes;
    }
    
    public function testSearchByRef()
    {
        $type = $this->searchTypes->getSearchTypeByRef('entry');
    ...
    public function testSearchTypeOptions()
    {
        ...
        $items = $this->searchTypes->getSearchTypeOptions($searchType);
    ...
    public function testDiffOptions()
    {
        ...
        $actual = $selected = $this->searchTypes->getDiffOptions($options, $selects);
    ...
    public function testSetItemSelected()
    {
        ...
        $selected = $this->searchTypes->setSelectedItems($items);
    ...
    public function testGetCustomFieldSearchType()
    {
        $field = SuperFilter::$app->searchTypes->getCustomSearchFieldType('title');
        
        $this->assertInstanceOf(Title::class, $field);
    }
}
