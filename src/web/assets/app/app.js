...
Vue.component('search-list', {
  ...
  methods: {
    ...
    getItems: function getItems() {
      ...
      axios.post('/super-filter/show-list', qs.stringify(data)).then(function (_ref) {
        var data = _ref.data;
        _this.loading = false;
        _this.items = data.items;

        if (_this.limit === '*') {
          _this.itemTotal = data.params.total;
        }

        _this.config.total = data.params.total;
      });
    },
    updateList: function updateList(currentPage) {
  ...
  mounted: function mounted() {
    ...
    // }
    console.log('fasdf'); // this.getItems();
  },
  computed: {
...
/***/ 0:
/*!******************************************************!*\
  !*** multi ./js/app.js ./css/app.scss ./css/cp.scss ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\MAMP\htdocs\craft3\localplugins\pdaleramirez\super-filter\resources\js\app.js */"./js/app.js");
__webpack_require__(/*! C:\MAMP\htdocs\craft3\localplugins\pdaleramirez\super-filter\resources\css\app.scss */"./css/app.scss");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\craft3\localplugins\pdaleramirez\super-filter\resources\css\cp.scss */"./css/cp.scss");
